...
nsys profile --stats=true --trace=nvtx,mpi,cuda --mpi-impl=openmpi --force-overwrite=true mpiexecjl -np 2 julia --project=${HOME}/.julia/dev/CurvilinearDiffusion -t 1 run.jl  > nsys_profile.output 2>&1
