...
@inline function update_metric_cache!(
  αᵢⱼ, βᵢⱼ, cell_center_metrics, edge_metrics, idx::CartesianIndex{2}
)
  @inbounds begin
    idim, jdim, = (1, 2)
    ᵢ₋₁ = shift(idx, idim, -1)
...
@inline function update_metric_cache!(
  αᵢⱼₖ, βᵢⱼₖ, γᵢⱼₖ, cell_center_metrics, edge_metrics, idx::CartesianIndex{3}
)
  @inbounds begin
