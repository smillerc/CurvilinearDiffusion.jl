...
function assemble!(A::SparseMatrixCSC, u, scheme::ImplicitScheme{2}, mesh, Δt)
  backend = scheme.backend
  workgroup = (64,)

  # @show scheme.limits, length(scheme.iterators.full.cartesian)
  # @show mesh.iterators.cell.domain
  # @show scheme.iterators.mesh
